$(document).ready(function() {
  ...
  $(".menu_button").on("click", function() {
    // if ($(".menu_button")[0] != $("#info_button")[0] && $("#middle-slide").hasClass("active")) {
  ...
  $("#info_button").on("click", function() {
      if (!$("#middle-slide").hasClass("active")) {
          ...
          $("#middle-slide-content").html("<p>Originally colonized by England in 1632, Antigua is a Caribbean island with a profoundly revelatory historical " +
  ...
  $("#credit_button").on("click", function() {
      if (!$("#middle-slide").hasClass("active")) {
          ...
          $("#middle-slide-title").addClass("active");
          $("#middle-slide-content").addClass("active");
          $("#middle-slide-content").html("<p>The Bucknell University Griot Institute for Africana Studies Antigua Sugar Mills project is grounded entirely on the decades-long work and research of Agnes Meeker, an independent researcher and lay historian whose passion has been gathering information on the sugar mills and plantations of the island.</p>" +
